...
`);
                    ...
                    for (let m = d + 1; m < t.length; m++)
                        ...
                        c === ke)
                            ...
                            if (c === Ue && t.charCodeAt(m + 1) === le)
                                throw new Error(`Unterminated string: ${t.slice(g, m + 1) + String.fromCharCode(u)}`);
                            if (c === le)
                                throw new Error(`Unterminated string: ${t.slice(g, m) + String.fromCharCode(u)}`)
                        }
                    l += t.slice(g, d + 1)
                } else {
                    if ((u === we || u === le || u === _e) && (c = t.charCodeAt(d + 1)) && (c === we || c === le || c === _e))
                        continue;
                    if (u === le) {
                        if (l.length === 0)
                            continue;
                        ...
                        for (let b = d + 2; b < t.length; b++)
                            ...
                            c === ke)
                                ...
                                (c === Vt || c === ao || c === tt) && g.length > 0 && t[b] === g[g.length - 1] && (g = g.slice(0, -1));
                        let y = ot(l, v);
                        if (!y)
                            throw new Error("Invalid custom property, expected a value");
                        n ? n.nodes.push(y) : r.push(y),
                            l = ""
                        ...
                        let g = ot(l);
                        if (!g)
                            throw l.length === 0 ? new Error("Unexpected semicolon") : new Error(`Invalid declaration: \`${l.trim()}\``);
                        n ? n.nodes.push(g) : r.push(g),
                            l = ""
                        ...
                        if (l.length === 0 && (u === we || u === le || u === _e))
                            continue;
                        l += String.fromCharCode(u)
                    }
                }
            }
            if (l.charCodeAt(0) === rt && r.push(xe(l)),
            p.length > 0 && n) {
                if (n.kind === "rule")
        ...
        function re(t) {
            ...
            let r = String(t), o = r.length, e = -1, n, s = "", l = r.charCodeAt(0);
            if (o === 1 && l === 45)
                return "\\" + r;
            for (; ++e < o; ) {
                if (n = r.charCodeAt(e),
        ...
        var Ot = new Map([["--font", ["--font-weight", "--font-size"]], ["--inset", ["--inset-shadow", "--inset-ring"]], ["--text", ["--text-color", "--text-underline-offset", "--text-indent", "--text-decoration-thickness", "--text-decoration-color"]]]);
        function Rt(t, r) {
                ...
                keysInNamespaces(r) {
                    ...
                    for (let e of r) {
                        ...
                        for (let s of this.values.keys())
                            s.startsWith(n) && s.indexOf("--", 2) === -1 && (Rt(s, e) || o.push(s.slice(n.length)))
                    }
                    return o
                }
                get(r) {
        ...
        function ee(t, r, o=null) {
            for (let e = 0; e < t.length; e++) {
                let n = t[e]
                    ...
                    replaceWith(c) {
                        s = !0,
                            Array.isArray(c) ? c.length === 0 ? (t.splice(e, 1),
                                l = 0) : c.length === 1 ? (t[e] = c[0],
                                l = 1) : (t.splice(e, 1, ...c),
                                l = c.length) : t[e] = c
                    }
                }) ?? 0;
            ...
            for (let l = 0; l < t.length; l++) {
                ...
                switch (p) {
                    ...
                    case Lt:
                    {
                        ...
                        let c = l
                            , d = l + 1;
                        for (; d < t.length && (s = t.charCodeAt(d),
                            !(s !== Pt && s !== Ut && s !== _t && s !== Dt && s !== zt && s !== jt && s !== Ft && s !== It && s !== Lt)); d++)
                            ;
                        l = d - 1;
        ...
        function U(t, r, o=[], e={}) {
            for (let n = 0; n < t.length; n++) {
                ...
                let p = !1
                    ...
                    replaceWith(u) {
                        p = !0,
                            Array.isArray(u) ? u.length === 0 ? (t.splice(n, 1),
                                c = 0) : u.length === 1 ? (t[n] = u[0],
                                c = 1) : (t.splice(n, 1, ...u),
                                c = u.length) : (t[n] = u,
                                c = 1)
                    }
            ...
            for (let n = 0; n < t.length; n++) {
                ...
                o.push(s),
                    r(s, {
                        ...
                        path: o,
                        replaceWith(p) {
                            Array.isArray(p) ? p.length === 0 ? t.splice(n, 1) : p.length === 1 ? t[n] = p[0] : t.splice(n, 1, ...p) : t[n] = p,
                                n += p.length - 1
                        }
                    }),
                    o.pop()
        ...
        function se(t, r) {
            ...
            function c(u, g, m={}, v=0) {
                if (u.kind === "declaration") {
                    if (u.property === "--tw-sort" || u.value === void 0 || u.value === null)
                        return;
                    if (m.theme && u.property[0] === "-" && u.property[1] === "-" && (m.keyframes || n.get(g).add(u)),
                        u.value.includes("var("))
                        if (m.theme && u.property[0] === "-" && u.property[1] === "-")
                            for (let y of je(u.value))
                                p.get(y).add(u.property);
                        else
                            r.trackUsedVariables(u.value);
                    ...
                    (y.nodes.length > 0 || y.name === "@layer" || y.name === "@charset" || y.name === "@custom-media" || y.name === "@namespace" || y.name === "@import") && g.push(y)
                    ...
                    u.length === 0) {
                        ...
                        do {
                            ...
                            if (!x)
                                break;
                            let T = b[b.length - 1];
                            if (!T || T.kind !== "at-root" && T.kind !== "at-rule")
                                break;
...
`;
        ...
        function Bt(t) {
            if (!st.some(n => t.includes(n)))
                return t;
            let r = !1;
            Ie.some(n => t.includes(n)) && (Wt.lastIndex = 0,
                t = t.replace(Wt, (n, s) => (r = !0,
                    `$${Ie.indexOf(s)}$(`)));
            let o = ""
                , e = [];
            for (let n = 0; n < t.length; n++) {
        ...
        function *Yt(t, r) {
            ...
            if (l[l.length - 1] === "]") {
                ...
                u = Zt(l, g => r.utilities.has(g, "functional"));
            for (let[g,m] of u) {
                let v = {
                    kind: "functional",
                    root: g,
                ...
                for (let[l,p] of s)
                    switch (r.variants.kind(l)) {
                        ...
                        case "compound":
                        {
                            ...
                            if (c === null || !r.variants.compoundsWith(l, c))
                                return null;
        ...
        function ce(t, r) {
            return P(t, ",").map(e => {
                    ...
                    let n = P(e, " ").filter(d => d.trim() !== "")
                        ...
                        , p = null;
                    for (let d of n)
                        Ho.has(d) || (tr.test(d) ? (l === null ? l = d : p === null && (p = d),
                            tr.lastIndex = 0) : s === null && (s = d));
                    if (l === null || p === null)
                        return e;
        ...
        ;
        function S(t, r, o) {
            return _("@property", t, [a("syntax", o ? `"${o}"` : '"*"'), a("inherits", "false"), ...r ? [a("initial-value", r)] : []])
        }
        function J(t, r) {
            if (r === null)
                return t;
        ...
        function or(t) {
                    ...
                    return k => {
                        ...
                        if (k.value)
                            if (k.value.kind === "arbitrary") {
                                ...
                                if ($ = t.resolve(k.value.fraction ?? k.value.value, f.themeKeys ?? []),
                                ...
                                if ($ === null && w && f.handleNegativeBareValue) {
                                    if ($ = f.handleNegativeBareValue(k.value),
                                    !$?.includes("/") && k.modifier)
                                        return;
                                    if ($ !== null)
                                        return f.handle($)
                                }
                                if ($ === null && f.handleBareValue && ($ = f.handleBareValue(k.value),
                                !$?.includes("/") && k.modifier))
                                    return
                            }
                        else {
                            if (k.modifier)
                                return;
                            $ = f.defaultValue !== void 0 ? f.defaultValue : t.resolve(null, f.themeKeys ?? [])
                        }
                        if ($ !== null)
                            return f.handle(w ? `calc(${$} * -1)` : $)
                    }
                }
            ...
            function s(i, f) {
                r.functional(i, h => {
                        if (!h.value)
                            return;
                        let w = null;
                        if (h.value.kind === "arbitrary" ? (w = h.value.value,
                            w = W(w, h.modifier, t)) : w = G(h, t, f.themeKeys),
                        w !== null)
                            return f.handle(w)
                    }
                ),
            ...
            function l(i, f, h, {supportsNegative: w=!1, supportsFractions: k=!1}={}) {
            ...
            for (let[i,f] of [["inset", "inset"], ["inset-x", "inset-inline"], ["inset-y", "inset-block"], ["start", "inset-inline-start"], ["end", "inset-inline-end"], ["top", "top"], ["right", "right"], ["bottom", "bottom"], ["left", "left"]])
                e(`${i}-auto`, [[f, "auto"]]),
                    e(`${i}-full`, [[f, "100%"]]),
                    e(`-${i}-full`, [[f, "-100%"]]),
            ...
            for (let[i,f] of [["m", "margin"], ["mx", "margin-inline"], ["my", "margin-block"], ["ms", "margin-inline-start"], ["me", "margin-inline-end"], ["mt", "margin-top"], ["mr", "margin-right"], ["mb", "margin-bottom"], ["ml", "margin-left"]])
                e(`${i}-auto`, [[f, "auto"]]),
            ...
            for (let[i,f] of [["auto", "auto"], ["full", "100%"], ["svw", "100svw"], ["lvw", "100lvw"], ["dvw", "100dvw"], ["svh", "100svh"], ["lvh", "100lvh"], ["dvh", "100dvh"], ["min", "min-content"], ["max", "max-content"], ["fit", "fit-content"]])
                e(`size-${i}`, [["--tw-sort", "size"], ["width", f], ["height", f]]),
                    e(`w-${i}`, [["width", f]]),
            ...
            for (let[i,f,h] of [["w", ["--width", "--spacing", "--container"], "width"], ["min-w", ["--min-width", "--spacing", "--container"], "min-width"], ["max-w", ["--max-width", "--spacing", "--container"], "max-width"], ["h", ["--height", "--spacing"], "height"], ["min-h", ["--min-height", "--height", "--spacing"], "min-height"], ["max-h", ["--max-height", "--height", "--spacing"], "max-height"]])
                l(i, f, w => [a(h, w)], {
                    supportsFractions: !0
                });
            r.static("container", () => {
            ...
            l("border-spacing", ["--border-spacing", "--spacing"], i => [p(), a("--tw-border-spacing-x", i), a("--tw-border-spacing-y", i), a("border-spacing", "var(--tw-border-spacing-x) var(--tw-border-spacing-y)")]),
                l("border-spacing-x", ["--border-spacing", "--spacing"], i => [p(), a("--tw-border-spacing-x", i), a("border-spacing", "var(--tw-border-spacing-x) var(--tw-border-spacing-y)")]),
                l("border-spacing-y", ["--border-spacing", "--spacing"], i => [p(), a("--tw-border-spacing-y", i), a("border-spacing", "var(--tw-border-spacing-x) var(--tw-border-spacing-y)")]),
            ...
            e("translate-none", [["translate", "none"]]),
                e("-translate-full", [c, ["--tw-translate-x", "-100%"], ["--tw-translate-y", "-100%"], ["translate", "var(--tw-translate-x) var(--tw-translate-y)"]]),
                e("translate-full", [c, ["--tw-translate-x", "100%"], ["--tw-translate-y", "100%"], ["translate", "var(--tw-translate-x) var(--tw-translate-y)"]]),
            ...
            for (let i of ["x", "y"])
                e(`-translate-${i}-full`, [c, [`--tw-translate-${i}`, "-100%"], ["translate", "var(--tw-translate-x) var(--tw-translate-y)"]]),
                    e(`translate-${i}-full`, [c, [`--tw-translate-${i}`, "100%"], ["translate", "var(--tw-translate-x) var(--tw-translate-y)"]]),
            ...
            function u({negative: i}) {
                return f => {
                    ...
                    return f.value.kind === "arbitrary" ? (h = f.value.value,
                        [a("scale", h)]) : (h = t.resolve(f.value.value, ["--scale"]),
                    !h && N(f.value.value) && (h = `${f.value.value}%`),
                        h ? (h = i ? `calc(${h} * -1)` : h,
                            [d(), a("--tw-scale-x", h), a("--tw-scale-y", h), a("--tw-scale-z", h), a("scale", "var(--tw-scale-x) var(--tw-scale-y)")]) : void 0)
                }
            }
            ...
            e("scale-3d", [d, ["scale", "var(--tw-scale-x) var(--tw-scale-y) var(--tw-scale-z)"]]),
            ...
            function g({negative: i}) {
                return f => {
                    ...
                    if (f.value.kind === "arbitrary") {
                        ...
                        if (w === "vector")
                            return [a("rotate", `${h} var(--tw-rotate)`)];
                        if (w !== "angle")
                            return [a("rotate", h)]
                    } else if (h = t.resolve(f.value.value, ["--rotate"]),
                ...
                n("skew", {
                    ...
                    r.functional("transform", h => {
                            if (h.modifier)
                                return;
                            let w = null;
                            if (h.value ? h.value.kind === "arbitrary" && (w = h.value.value) : w = i,
                            w !== null)
            ...
            for (let i of ["x", "left", "right"])
                e(`touch-pan-${i}`, [m, ["--tw-pan-x", `pan-${i}`], ["touch-action", "var(--tw-pan-x,) var(--tw-pan-y,) var(--tw-pinch-zoom,)"]]);
            for (let i of ["y", "up", "down"])
                e(`touch-pan-${i}`, [m, ["--tw-pan-y", `pan-${i}`], ["touch-action", "var(--tw-pan-x,) var(--tw-pan-y,) var(--tw-pinch-zoom,)"]]);
            ...
            for (let i of ["x", "y", "both"])
                e(`snap-${i}`, [v, ["scroll-snap-type", `${i} var(--tw-scroll-snap-strictness)`]]);
            ...
            for (let[i,f] of [["scroll-m", "scroll-margin"], ["scroll-mx", "scroll-margin-inline"], ["scroll-my", "scroll-margin-block"], ["scroll-ms", "scroll-margin-inline-start"], ["scroll-me", "scroll-margin-inline-end"], ["scroll-mt", "scroll-margin-top"], ["scroll-mr", "scroll-margin-right"], ["scroll-mb", "scroll-margin-bottom"], ["scroll-ml", "scroll-margin-left"]])
                l(i, ["--scroll-margin", "--spacing"], h => [a(f, h)], {
                    supportsNegative: !0
                });
            for (let[i,f] of [["scroll-p", "scroll-padding"], ["scroll-px", "scroll-padding-inline"], ["scroll-py", "scroll-padding-block"], ["scroll-ps", "scroll-padding-inline-start"], ["scroll-pe", "scroll-padding-inline-end"], ["scroll-pt", "scroll-padding-top"], ["scroll-pr", "scroll-padding-right"], ["scroll-pb", "scroll-padding-bottom"], ["scroll-pl", "scroll-padding-left"]])
            ...
            e("grid-flow-row", [["grid-auto-flow", "row"]]),
                ...
                n("grid-cols", {
                    ...
                    handleBareValue: ({value: i}) => pt(i) ? `repeat(${i}, minmax(0, 1fr))` : null,
                ...
                l("space-x", ["--space", "--spacing"], i => [D([S("--tw-space-x-reverse", "0")]), z(":where(& > :not(:last-child))", [a("--tw-sort", "row-gap"), a("--tw-space-x-reverse", "0"), a("margin-inline-start", `calc(${i} * var(--tw-space-x-reverse))`), a("margin-inline-end", `calc(${i} * calc(1 - var(--tw-space-x-reverse)))`)])], {
                    supportsNegative: !0
                }),
                ...
                e("space-x-reverse", [ () => D([S("--tw-space-x-reverse", "0")]), () => z(":where(& > :not(:last-child))", [a("--tw-sort", "row-gap"), a("--tw-space-x-reverse", "1")])]),
                e("space-y-reverse", [ () => D([S("--tw-space-y-reverse", "0")]), () => z(":where(& > :not(:last-child))", [a("--tw-sort", "column-gap"), a("--tw-space-y-reverse", "1")])]),
            ...
            e("scroll-auto", [["scroll-behavior", "auto"]]),
                ...
                !1;
            for (let[i,f] of [["rounded", ["border-radius"]], ["rounded-s", ["border-start-start-radius", "border-end-start-radius"]], ["rounded-e", ["border-start-end-radius", "border-end-end-radius"]], ["rounded-t", ["border-top-left-radius", "border-top-right-radius"]], ["rounded-r", ["border-top-right-radius", "border-bottom-right-radius"]], ["rounded-b", ["border-bottom-right-radius", "border-bottom-left-radius"]], ["rounded-l", ["border-top-left-radius", "border-bottom-left-radius"]], ["rounded-ss", ["border-start-start-radius"]], ["rounded-se", ["border-start-end-radius"]], ["rounded-ee", ["border-end-end-radius"]], ["rounded-es", ["border-end-start-radius"]], ["rounded-tl", ["border-top-left-radius"]], ["rounded-tr", ["border-top-right-radius"]], ["rounded-br", ["border-bottom-right-radius"]], ["rounded-bl", ["border-bottom-left-radius"]]])
                e(`${i}-none`, f.map(h => [h, "0"])),
                    e(`${i}-full`, f.map(h => [h, "calc(infinity * 1px)"])),
                    n(i, {
                        themeKeys: ["--radius"],
                ...
                e("border-none", [["--tw-border-style", "none"], ["border-style", "none"]]);
            {
                let f = function(h, w) {
                    r.functional(h, k => {
                            ...
                            if (k.value.kind === "arbitrary") {
                                let $ = k.value.value;
                                switch (k.value.dataType ?? I($, ["color", "line-width", "length"])) {
                                    case "line-width":
                                    case "length":
                                    {
                                        if (k.modifier)
                ...
                f("border", {
                    ...
                    e("divide-x-reverse", [ () => D([S("--tw-divide-x-reverse", "0")]), () => z(":where(& > :not(:last-child))", [a("--tw-divide-x-reverse", "1")])]),
                    e("divide-y-reverse", [ () => D([S("--tw-divide-y-reverse", "0")]), () => z(":where(& > :not(:last-child))", [a("--tw-divide-y-reverse", "1")])]);
                for (let h of ["solid", "dashed", "dotted", "double", "none"])
                    e(`divide-${h}`, [ () => z(":where(& > :not(:last-child))", [a("--tw-sort", "divide-style"), a("--tw-border-style", h), a("border-style", h)])])
            }
                    ...
                    return E => {
                        ...
                        if (E.value.kind === "arbitrary") {
                            ...
                            switch (E.value.dataType ?? I(j, ["angle"])) {
                                ...
                                default:
                                    return $ ? void 0 : [a("--tw-gradient-position", j), a("background-image", `linear-gradient(var(--tw-gradient-stops,${j}))`)]
                            }
                        }
                        let C = E.value.value;
                        if (!$ && f.has(C))
                        ...
                        if (h.value) {
                            if (h.value.kind === "arbitrary") {
                                ...
                                switch (h.value.dataType ?? I(w, ["color", "length", "percentage"])) {
                                    ...
                                    default:
                                        return w = W(w, h.modifier, t),
                                            w === null ? void 0 : f.color(w)
                                }
                            }
                            {
                            ...
                            }
                            {
                                ...
                                if (w)
                                    return f.position(w);
                                if (h.value.value[h.value.value.length - 1] === "%" && N(h.value.value.slice(0, -1)))
                        ...
                        if (i.value) {
                            if (i.value.kind === "arbitrary") {
                                ...
                                switch (i.value.dataType ?? I(f, ["color", "number", "length", "percentage"])) {
                                    ...
                                    default:
                                        return f = W(i.value.value, i.modifier, t),
            ...
            for (let[i,f] of [["p", "padding"], ["px", "padding-inline"], ["py", "padding-block"], ["ps", "padding-inline-start"], ["pe", "padding-inline-end"], ["pt", "padding-top"], ["pr", "padding-right"], ["pb", "padding-bottom"], ["pl", "padding-left"]])
                ...
                r.functional("decoration", i => {
                        if (i.value) {
                            ...
                            }
                            {
                                ...
                                if (f)
                                    return [a("text-decoration-color", f)]
                            }
                        }
                    }
                ),
                ...
                });
            {
                ...
                r.functional("filter", k => {
                    ...
                    r.functional("backdrop-filter", k => {
                            if (!k.modifier) {
                                if (k.value === null)
                                    return [w(), a("-webkit-backdrop-filter", f), a("backdrop-filter", f)];
                                if (k.value.kind === "arbitrary")
                    ...
                    e("backdrop-blur-none", [w, ["--tw-backdrop-blur", " "], ["-webkit-backdrop-filter", f], ["backdrop-filter", f]]),
                    n("brightness", {
                    ...
                    n("drop-shadow", {
                        ...
                        handle: k => [h(), a("--tw-drop-shadow", P(k, ",").map($ => `drop-shadow(${$})`).join(" ")), a("filter", i)]
                    }),
                    n("backdrop-opacity", {
            ...
            }
            {
                ...
                e("transition-none", [["transition-property", "none"]]),
                    e("transition-all", [["transition-property", "all"], ["transition-timing-function", i], ["transition-duration", f]]),
                    e("transition-colors", [["transition-property", "color, background-color, border-color, outline-color, text-decoration-color, fill, stroke, --tw-gradient-from, --tw-gradient-via, --tw-gradient-to"], ["transition-timing-function", i], ["transition-duration", f]]),
                    e("transition-opacity", [["transition-property", "opacity"], ["transition-timing-function", i], ["transition-duration", f]]),
                    e("transition-shadow", [["transition-property", "box-shadow"], ["transition-timing-function", i], ["transition-duration", f]]),
                    e("transition-transform", [["transition-property", "transform, translate, scale, rotate"], ["transition-timing-function", i], ["transition-duration", f]]),
                    n("transition", {
                ...
                });
            {
                ...
                e("contain-none", [["contain", "none"]]),
                    ...
                    e("contain-inline-size", [f, ["--tw-contain-size", "inline-size"], ["contain", i]]),
                    e("contain-layout", [f, ["--tw-contain-layout", "layout"], ["contain", i]]),
                    e("contain-paint", [f, ["--tw-contain-paint", "paint"], ["contain", i]]),
                    e("contain-style", [f, ["--tw-contain-style", "style"], ["contain", i]]),
                    n("contain", {
                        themeKeys: [],
            ...
            e("forced-color-adjust-none", [["forced-color-adjust", "none"]]),
                ...
                l("leading", ["--leading", "--spacing"], i => [D([S("--tw-leading")]), a("--tw-leading", i), a("line-height", i)]),
                n("tracking", {
                    supportsNegative: !0,
                    themeKeys: ["--tracking"],
                ...
                e("subpixel-antialiased", [["-webkit-font-smoothing", "auto"], ["-moz-osx-font-smoothing", "auto"]]);
            {
                ...
                e("normal-nums", [["font-variant-numeric", "normal"]]),
                    e("ordinal", [f, ["--tw-ordinal", "ordinal"], ["font-variant-numeric", i]]),
                    e("slashed-zero", [f, ["--tw-slashed-zero", "slashed-zero"], ["font-variant-numeric", i]]),
                    e("lining-nums", [f, ["--tw-numeric-figure", "lining-nums"], ["font-variant-numeric", i]]),
                    e("oldstyle-nums", [f, ["--tw-numeric-figure", "oldstyle-nums"], ["font-variant-numeric", i]]),
                    e("proportional-nums", [f, ["--tw-numeric-spacing", "proportional-nums"], ["font-variant-numeric", i]]),
                    e("tabular-nums", [f, ["--tw-numeric-spacing", "tabular-nums"], ["font-variant-numeric", i]]),
                    e("diagonal-fractions", [f, ["--tw-numeric-fraction", "diagonal-fractions"], ["font-variant-numeric", i]]),
                    e("stacked-fractions", [f, ["--tw-numeric-fraction", "stacked-fractions"], ["font-variant-numeric", i]])
            }
            {
                let i = () => D([S("--tw-outline-style", "solid")]);
                r.static("outline-hidden", () => [a("outline-style", "none"), _("@media", "(forced-colors: active)", [a("outline", "2px solid transparent"), a("outline-offset", "2px")])]),
                    ...
                    r.functional("outline", f => {
                            ...
                            }
                            {
                                ...
                                if (h)
                                    return [i(), a("outline-style", "var(--tw-outline-style)"), a("outline-width", h)];
                                if (N(f.value.value))
                                    return [i(), a("outline-style", "var(--tw-outline-style)"), a("outline-width", `${f.value.value}px`)]
                            }
                        }
                    ),
                    o("outline", () => [{
                                ...
                                switch (i.value.dataType ?? I(f, ["color", "length", "percentage", "absolute-size", "relative-size"])) {
                                    ...
                                    case "relative-size":
                                    {
                                        if (i.modifier) {
                                            ...
                                            return !w && i.modifier.value === "none" && (w = "1"),
                            ...
                            }
                            {
                                ...
                                if (f) {
                                    ...
                                    if (i.modifier) {
                                        ...
                                        if (!k && i.modifier.value === "none" && (k = "1"),
                                            !k)
                                            return null;
                                        let $ = [a("font-size", h)];
                ...
                }]);
            {
                ...
                e("shadow-initial", [h, ["--tw-shadow-color", "initial"]]),
                    r.functional("shadow", C => {
                            if (!C.value) {
                                let A = t.get(["--shadow"]);
                                return A === null ? void 0 : [h(), a("--tw-shadow", ce(A, j => `var(--tw-shadow-color, ${j})`)), a("box-shadow", i)]
                            }
                            ...
                            }
                            {
                                ...
                                if (A)
                                    return C.modifier ? void 0 : [h(), a("--tw-shadow", ce(A, j => `var(--tw-shadow-color, ${j})`)), a("box-shadow", i)]
                            }
                            {
                                let A = G(C, t, ["--box-shadow-color", "--color"]);
                                if (A)
                                    return [h(), a("--tw-shadow-color", A)]
                            }
                        }
                    ),
                    o("shadow", () => [{
                    ...
                    r.functional("inset-shadow", C => {
                            if (!C.value) {
                                ...
                                return A === null ? void 0 : [h(), a("--tw-inset-shadow", ce(A, j => `var(--tw-inset-shadow-color, ${j})`)), a("box-shadow", i)]
                            }
                            if (C.value.kind === "arbitrary") {
                                let A = C.value.value;
                                switch (C.value.dataType ?? I(A, ["color"])) {
                            ...
                            }
                            {
                                ...
                                if (A)
                                    return C.modifier ? void 0 : [h(), a("--tw-inset-shadow", ce(A, j => `var(--tw-inset-shadow-color, ${j})`)), a("box-shadow", i)]
                            }
                            {
                                let A = G(C, t, ["--box-shadow-color", "--color"]);
                                if (A)
                                    return [h(), a("--tw-inset-shadow-color", A)]
                            }
                        }
                    ),
                    o("inset-shadow", () => [{
                ...
                r.functional("ring", C => {
                    ...
                    r.functional("inset-ring", C => {
                            if (!C.value)
                                return C.modifier ? void 0 : [h(), a("--tw-inset-ring-shadow", $("1px")), a("box-shadow", i)];
                            if (C.value.kind === "arbitrary") {
                                let A = C.value.value;
                                switch (C.value.dataType ?? I(A, ["color", "length"])) {
                                    case "length":
                                        return C.modifier ? void 0 : [h(), a("--tw-inset-ring-shadow", $(A)), a("box-shadow", i)];
                                    default:
                                        return A = W(A, C.modifier, t),
                            ...
                            }
                            {
                                ...
                                if (A === null && N(C.value.value) && (A = `${C.value.value}px`),
                                    A)
                                    return [h(), a("--tw-inset-ring-shadow", $(A)), a("box-shadow", i)]
                            }
                        }
                    ),
                    o("inset-ring", () => [{
                        ...
                        if (C.value) {
                            ...
                            }
                            {
                                ...
                                if (A)
                                    return C.modifier ? void 0 : [a("--tw-ring-offset-width", A), a("--tw-ring-offset-shadow", E)];
                                if (N(C.value.value))
                                    return C.modifier ? void 0 : [a("--tw-ring-offset-width", `${C.value.value}px`), a("--tw-ring-offset-shadow", E)]
                            }
                            {
            ...
            return o("ring-offset", () => [{
                ...
                r.functional("@container", i => {
                        let f = null;
                        if (i.value === null ? f = "inline-size" : i.value.kind === "arbitrary" ? f = i.value.value : i.value.kind === "named" && i.value.value === "normal" && (f = "normal"),
                        f !== null)
                            return i.modifier ? [a("container-type", f), a("container-name", i.modifier.value)] : [a("container-type", f)]
                    }
                ),
                o("@container", () => [{
                    values: ["normal"],
        ...
        function nr(t) {
            ...
            return Jo.test(r) ? o => {
                    ...
                    U(t.nodes, s => {
                            ...
                            let l = L(s.value);
                            ee(l, p => {
                                    if (p.kind !== "function" || p.value !== "--value" && p.value !== "--modifier")
                                        return;
                                    let c = P(H(p.nodes), ",");
                        ...
                        o.utilities.functional(r.slice(0, -2), s => {
                                ...
                                let d = !1
                                    ...
                                    , v = new Map
                                    , y = !1;
                                if (U([l], (b, {parent: x, replaceWith: T}) => {
        ...
        function he(t, r) {
            ...
            return U(t, e => {
                    if (e.kind === "declaration" && e.value && ir.test(e.value)) {
                        o |= 8,
                            e.value = lr(e.value, r);
                        return
                    }
                    e.kind === "at-rule" && (e.name === "@media" || e.name === "@custom-media" || e.name === "@container" || e.name === "@supports") && ir.test(e.params) && (o |= 8,
                        e.params = lr(e.params, r))
                }
            ),
                o
        }
            ...
            for (let s = 0; s < n; s++) {
                ...
                if (l >= 48 && l <= 57 && p >= 48 && p <= 57) {
                    let c = s
                        ...
                        , u = s
                        , g = s + 1;
                    for (l = t.charCodeAt(d); l >= 48 && l <= 57; )
                        l = t.charCodeAt(++d);
                    for (p = r.charCodeAt(g); p >= 48 && p <= 57; )
                        p = r.charCodeAt(++g);
                    let m = t.slice(c, d)
                        , v = r.slice(u, g)
                        , y = Number(m) - Number(v);
        ...
        function sr(t) {
            ...
            return r.length === 0 ? [] : (r.sort( (e, n) => We(e.name, n.name)),
                rn(r))
        }
        function rn(t) {
            let r = []
        ...
        function ur(t) {
            ...
            for (let[e,n] of t.variants.entries()) {
                let p = function({value: c, modifier: d}={}) {
                    ...
                    if (be(m, g, t.variants) === null)
                        return [];
                    let v = [];
                    return Fe(m.nodes, (y, {path: b}) => {
        ...
        function dr(t) {
            ...
            function s(d) {
                for (let u of n) {
                    if (u !== d.name)
                        continue;
                    let g = P(d.params, ",");
                    return g.length > 1 ? null : (g = e(d.name, g),
                        _(d.name, g.join(", ")))
                }
                return null
            }
            function l(d) {
                return d.includes("::") ? null : `&:not(${P(d, ",").map(g => (g.startsWith("&:is(") && g.endsWith(")") && (g = g.slice(5, -1)),
                    g = g.replaceAll("&", "*"),
                    g)).join(", ")})`
            }
            r.compound("not", 3, (d, u) => {
                    ...
                    if (U([d], (m, {path: v}) => {
                            ...
                            return Object.assign(d, z("&", x)),
                                g = !0,
                                1
                        }
                    ),
                    d.kind === "rule" && d.selector === "&" && d.nodes.length === 1 && Object.assign(d, d.nodes[0]),
                        !g)
                        return null
                }
            ),
                r.suggest("not", () => Array.from(r.keys()).filter(d => r.compoundsWith("not", d))),
                r.compound("group", 2, (d, u) => {
                        if (u.variant.kind === "arbitrary" && u.variant.relative)
                            return null;
                ...
                r.suggest("group", () => Array.from(r.keys()).filter(d => r.compoundsWith("group", d))),
                ...
                r.suggest("peer", () => Array.from(r.keys()).filter(d => r.compoundsWith("peer", d))),
            ...
            {
                let d = function() {
                    return D([_("@property", "--tw-content", [a("syntax", '"*"'), a("initial-value", '""'), a("inherits", "false")])])
                };
                var p = d;
                r.static("before", u => {
            ...
            o("first", ["&:first-child"]),
                ...
                r.suggest("in", () => Array.from(r.keys()).filter(d => r.compoundsWith("in", d))),
                ...
                r.suggest("has", () => Array.from(r.keys()).filter(d => r.compoundsWith("has", d))),
                ...
                r.functional("nth", (d, u) => {
                        if (!u.value || u.modifier || u.value.kind === "named" && !N(u.value.value))
                            return null;
                ...
                o("contrast-less", ["@media (prefers-contrast: less)"]);
            {
                ...
                var c = d;
                {
                            ...
                            switch (m.kind) {
                                ...
                                case "functional":
                                {
                                    if (!m.value || m.modifier)
                                        return null;
                                    let v = null;
                                    return m.value.kind === "arbitrary" ? v = m.value.value : m.value.kind === "named" && (v = t.resolveValue(m.value.value, ["--breakpoint"])),
                    ...
                    r.group( () => {
                        ...
                        , (m, v) => d(m, v, "desc", g)),
                        r.suggest("max", () => Array.from(u.keys()).filter(m => m !== null)),
                        r.group( () => {
                            ...
                            , (m, v) => d(m, v, "asc", g)),
                        r.suggest("min", () => Array.from(u.keys()).filter(m => m !== null))
                }
                {
                            ...
                            switch (m.kind) {
                                case "functional":
                                {
                                    if (m.value === null)
                                        return null;
                                    let v = null;
                                    return m.value.kind === "arbitrary" ? v = m.value.value : m.value.kind === "named" && (v = t.resolveValue(m.value.value, ["--container"])),
                                        !v || v.includes("var(") ? null : v
                                }
                                case "static":
                                case "arbitrary":
                    ...
                    r.group( () => {
                            r.functional("@max", (m, v) => {
                                    ...
                                    if (y === null)
                                        return null;
                                    m.nodes = [_("@container", v.modifier ? `${v.modifier.value} (width < ${y})` : `(width < ${y})`, m.nodes)]
                                }
                                , {
                                    compounds: 1
                                })
        ...
        function yt(t, r) {
            U(t, (o, {replaceWith: e}) => {
                    if (o.kind === "at-rule" && o.name === "@slot")
                        ...
                        return Object.assign(o, D([_(o.name, o.params, o.nodes)])),
                            1
                }
            )
        }
            ...
            let r = or(t)
                ...
                candidatesToCss(c) {
                    ...
                    for (let u of c) {
                        ...
                        m = se(m, p),
                            m.length === 0 || g ? d.push(null) : d.push(Y(m))
                    }
                    return d
                },
                getClassOrder(c) {
                ...
                getVariantOrder() {
                    ...
                    let d = new Map, u, g = 0;
                    for (let m of c)
                        m !== null && (u !== void 0 && this.variants.compare(u, m) !== 0 && g++,
                            d.set(m, g),
                            u = m);
                    return d
                },
        ...
        function ne(t, r, {onInvalidCandidate: o}={}) {
            ...
            return n.sort( (p, c) => {
                    ...
                    let g = 0;
                    for (; g < d.properties.order.length && g < u.properties.order.length && d.properties.order[g] === u.properties.order[g]; )
                        g += 1;
                    return (d.properties.order[g] ?? 1 / 0) - (u.properties.order[g] ?? 1 / 0) || u.properties.count - d.properties.count || We(d.candidate, u.candidate)
                }
            ),
                {
                    astNodes: n,
        ...
        function be(t, r, o, e=0) {
            ...
            if (r.kind === "compound") {
                let l = _("@slot");
                if (be(l, r.variant, o, e + 1) === null || r.root === "not" && l.nodes.length > 1)
                    return null;
        ...
        function hr(t) {
            for (let r of t)
                r.kind !== "at-root" && (r.kind === "declaration" && !(r.property[0] === "-" && r.property[1] === "-") ? r.important = !0 : (r.kind === "rule" || r.kind === "at-rule") && hr(r.nodes))
        }
        function an(t) {
            let r = new Set
                , o = 0
            ...
            function u(g, m=[]) {
                if (!p.has(g)) {
                    if (d.has(g)) {
                        ...
                        throw g.kind === "at-rule" && g.name === "@utility" && v.kind === "at-rule" && v.name === "@utility" && U(g.nodes, y => {
                                if (y.kind !== "at-rule" || y.name !== "@apply")
                                    return;
...
${Y([v])}`)
        ...
        async function kt(t, r, o, e=0) {
            let n = 0
                , s = [];
            return U(t, (l, {replaceWith: p}) => {
                    if (l.kind === "at-rule" && (l.name === "@import" || l.name === "@reference")) {
                        let c = sn(L(l.params));
                        if (c === null)
                            return;
                        l.name === "@reference" && (c.media = "reference"),
                            n |= 2;
                        let {uri: d, layer: u, media: g, supports: m} = c;
                        if (d.startsWith("data:") || d.startsWith("http://") || d.startsWith("https://"))
                            return;
                        let v = Q({}, []);
                        return s.push((async () => {
                                if (e > 100)
                                    throw new Error(`Exceeded maximum recursion depth while resolving \`${d}\` in \`${r}\`)`);
                                let y = await o(d, r)
                                    , b = pe(y.content);
            ...
            for (let n of r)
                if (n != null)
                    for (let s of Reflect.ownKeys(n)) {
                        e.push(s);
                        let l = o(t[s], n[s], e);
                        l !== void 0 ? t[s] = l : !ve(t[s]) || !ve(n[s]) ? t[s] = n[s] : t[s] = Ne({}, [t[s], n[s]], o, e),
                            e.pop()
                    }
            return t
        }
        function Ge(t, r, o) {
            return function(n, s) {
                let l = n.lastIndexOf("/")
                    , p = null;
                l !== -1 && (p = n.slice(l + 1).trim(),
                    n = n.slice(0, l).trim());
                let c = ( () => {
                        let d = He(n)
                            , [u,g] = mn(t.theme, d)
                            , m = o(kr(r() ?? {}, d) ?? null);
                        if (typeof m == "string" && (m = m.replace("<alpha-value>", "1")),
                        typeof u != "object")
                        ...
                        if (m !== null && typeof m == "object" && !Array.isArray(m)) {
                            ...
                            if (u === null && Object.hasOwn(m, "__CSS_VALUES__")) {
                                let y = {};
                                for (let b in m.__CSS_VALUES__)
                                    y[b] = m[b],
                                        delete v[b];
                                u = y
                            }
                            for (let y in u)
                                y !== "__CSS_VALUES__" && (m?.__CSS_VALUES__?.[y] & 4 && kr(v, y.split("-")) !== void 0 || (v[ae(y)] = u[y]));
                            return v
                        }
                        if (Array.isArray(u) && Array.isArray(g) && Array.isArray(m)) {
                            let v = u[0]
                                , y = u[1];
                            g[0] & 4 && (v = m[0] ?? v);
                            for (let b of Object.keys(y))
                                g[1][b] & 4 && (y[b] = m[1][b] ?? y[b]);
                            return [v, y]
                        }
                        return u ?? m
                    }
                )();
                return p && typeof c == "string" && (c = J(c, p)),
                c ?? s
            }
        }
        function mn(t, r) {
            ...
            for (let[u,g] of l)
                wr(d, [u ?? "DEFAULT"], g);
            return r[r.length - 1] === "DEFAULT" ? [c?.DEFAULT ?? null, d.DEFAULT ?? 0] : "DEFAULT"in c && Object.keys(c).length === 1 ? [c.DEFAULT, d.DEFAULT ?? 0] : (c.__CSS_VALUES__ = d,
                [c, d])
        }
        function kr(t, r) {
        ...
        function Ve(t, r, o=null) {
            for (let e = 0; e < t.length; e++) {
                ...
                if (p === 2)
                    return 2;
                if (p !== 1 && n.kind === "function" && Ve(n.nodes, r, n) === 2)
                    return 2
            }
        }
        function Ee(t) {
...
`);
                ...
                switch (p) {
                    ...
                    case Or:
                    {
                        ...
                        let c = l
                            , d = l + 1;
                        for (; d < t.length && (s = t.charCodeAt(d),
                            !(s !== Cr && s !== Sr && s !== $r && s !== Er && s !== Vr && s !== Rr && s !== Or)); d++)
                            ;
                        l = d - 1;
                        let u = t.slice(c, d)
                            , g = u.trim() === "," ? bn(u) : gn(u);
                    ...
                    case xr:
                    {
                        ...
                        n += String.fromCharCode(p) + String.fromCharCode(c),
                            l += 1;
                        break
                    }
                    default:
            ...
            return n.length > 0 && r.push(Te(n)),
                r
        }
        var Kr = /^[a-z@][a-zA-Z0-9/%._-]*$/;
        function wt({designSystem: t, ast: r, resolvedConfig: o, featuresRef: e, referenceMode: n}) {
            let s = {
                addBase(l) {
                    if (n)
                        return;
                ...
                matchVariant(l, p, c) {
                    ...
                    t.variants.group( () => {
                        ...
                        , (g, m) => {
                            if (g.kind !== "functional" || m.kind !== "functional")
                                return 0;
                ...
                addUtilities(l) {
                    ...
                    for (let[d,u] of p) {
                        ...
                        if (Ve(g, v => {
                            ...
                            !m)
                            throw new Error(`\`addUtilities({ '${d}' : \u2026 })\` defines an invalid utility selector. Utilities must be a single class name and start with a lowercase letter, eg. \`.scrollbar-none\`.`)
                    }
                    for (let[d,u] of c)
                        t.theme.prefix && U(u, g => {
                                if (g.kind === "rule") {
                                    let m = Ye(g.selector);
                                    Ve(m, v => {
                ...
                matchUtilities(l, p) {
                    ...
                    for (let[u,g] of Object.entries(l)) {
                        let m = function({negative: v}) {
                            return y => {
                                if (y.value?.kind === "arbitrary" && c.length > 0 && !c.includes("any") && (y.value.dataType && !c.includes(y.value.dataType) || !y.value.dataType && !I(y.value.value, c)))
                                    return;
                                    ...
                                    , T = !1;
                                {
                                    ...
                                    b && (R = Object.assign({
                                        ...
                                        y.value ? y.value.kind === "arbitrary" ? x = y.value.value : y.value.fraction && R[y.value.fraction] ? (x = R[y.value.fraction],
                                            T = !0) : R[y.value.value] ? x = R[y.value.value] : R.__BARE_VALUE__ && (x = R.__BARE_VALUE__(y.value) ?? null,
                                            T = (y.value.fraction !== null && x?.includes("/")) ?? !1) : x = R.DEFAULT ?? null
                                }
                                if (x === null)
                                    return;
                                let V;
                        ...
                        var d = m;
                        if (!Kr.test(u))
                            throw new Error(`\`matchUtilities({ '${u}' : \u2026 })\` defines an invalid utility name. Utilities should be alphanumeric and start with a lowercase letter, eg. \`scrollbar\`.`);
                        p?.supportsNegativeValues && t.utilities.functional(`-${u}`, m({
                            ...
                            t.utilities.suggest(u, () => {
                                    ...
                                    y.has("DEFAULT") && (y.delete("DEFAULT"),
                                        y.add(null));
                                    let b = p?.modifiers ?? {}
        ...
        function Vn(t, r) {
            if (Array.isArray(t) && ve(t[0]))
                return t.concat(r);
            if (Array.isArray(r) && ve(r[0]) && ve(t))
                return [t, ...r];
            if (Array.isArray(r))
                return r
        }
        function xt(t, {config: r, base: o, path: e, reference: n}) {
            ...
            for (let c of r.plugins ?? [])
                "__isOptionsFunction"in c ? s.push({
                    ...c(),
                    reference: n
                }) : "handler"in c ? s.push({
                    ...c,
            ...
            for (let c of p)
                t.content.files.push(typeof c == "object" ? c : {
                    base: o,
                    pattern: c
                });
            t.configs.push(r)
        ...
        function Rn({center: t, padding: r, screens: o}, e) {
            ...
            typeof o == "object" && o !== null) {
                ...
                if (l.sort( (p, c) => ue(p[1], c[1], "asc")),
                l.length > 0) {
                    let[p] = l[0];
                    n.push(_("@media", `(width >= --theme(--breakpoint-${p}))`, [a("max-width", "none")]))
                }
            ...
            if (typeof r == "object" && r !== null) {
                ...
                for (let[p,,c] of l)
                    if (s && s.has(p))
                        s.get(p).nodes.push(a("padding-inline", c));
                    else {
                        if (s)
                            continue;
                        n.push(_("@media", `(width >= theme(--breakpoint-${p}))`, [a("padding-inline", c)]))
                    }
            }
            if (s)
                for (let[,l] of s)
        ...
        function Wr(t, r) {
            ...
            for (let[l,p] of Object.entries(o)) {
                ...
                if (c && d && !r.theme.hasDefault(`--breakpoint-${l}`))
                    continue;
                let u = !0;
                typeof p == "string" && (u = !1);
                let g = On(p);
            ...
            if (n.length !== 0) {
                ...
                r.variants.compareFns = new Map(Array.from(r.variants.compareFns).map( ([l,p]) => (l > e && (l += n.length),
                    [l, p])));
                for (let[l,p] of n.entries())
                    p(e + l + 1)
            }
        }
        function On(t) {
        ...
        var Kn = /^[a-z]+$/;
        async function Hr({designSystem: t, base: r, ast: o, loadModule: e, globs: n}) {
            let s = 0
                , l = []
                , p = [];
...
Using an object as a plugin option is currently only supported in JavaScript configuration files.`)
            ...
            !l.length && !p.length)
                return 0;
            let[d,u] = await Promise.all([Promise.all(p.map(async ({id: g, base: m, reference: v}) => {
            ...
            )), Promise.all(l.map(async ([{id: g, base: m, reference: v},y]) => {
        ...
        function qr({designSystem: t, base: r, ast: o, globs: e, configs: n, pluginDetails: s}) {
            let l = 0
                , c = [...s.map(b => {
                    if (!b.options)
                        return {
            ...
            !t.theme.prefix && d.prefix) {
                if (d.prefix.endsWith("-") && (d.prefix = d.prefix.slice(0, -1),
                    console.warn(`The prefix "${d.prefix}" is invalid. Prefixes must be lowercase ASCII letters (a-z) only and is written as a variant before all utilities. We have fixed up the prefix for you. Remove the trailing \`-\` to silence this warning.`)),
                    !Kn.test(d.prefix))
                    throw new Error(`The prefix "${d.prefix}" is invalid. Prefixes must be lowercase ASCII letters (a-z) only.`);
                t.theme.prefix = d.prefix
            }
            if (!t.important && d.important === !0 && (t.important = !0),
            typeof d.important == "string") {
                let b = d.important;
                U(o, (x, {replaceWith: T, parent: V}) => {
                        if (x.kind === "at-rule" && !(x.name !== "@tailwind" || x.params !== "utilities"))
                            return V?.kind === "rule" && V.selector === b ? 2 : (T(z(b, [x])),
                                2)
                    }
                )
            }
            for (let b of d.blocklist)
...
This feature is not currently supported.`);
        ...
        async function zn(t, {base: r="", loadModule: o=Un, loadStylesheet: e=_n}={}) {
            let n = 0;
            t = [Q({
                base: r
            }, t)],
            ...
            U(t, (b, {parent: x, replaceWith: T, context: V}) => {
                    if (b.kind === "at-rule") {
                        if (b.name === "@tailwind" && (b.params === "utilities" || b.params.startsWith("utilities"))) {
                            ...
                            for (let R of O)
                                if (R.startsWith("source(")) {
                                    ...
                                    if (K[0] === '"' && K[K.length - 1] !== '"' || K[0] === "'" && K[K.length - 1] !== "'" || K[0] !== "'" && K[0] !== '"')
                        ...
                        if (b.name === "@variant" && (x === null ? b.nodes.length === 0 ? b.name = "@custom-variant" : (U(b.nodes, O => {
                                if (O.kind === "at-rule" && O.name === "@slot")
                                    return b.name = "@custom-variant",
                                        2
                            }
                        ),
                        b.name === "@variant" && g.push(b)) : g.push(b)),
                        b.name === "@custom-variant") {
                            ...
                            let[O,R] = P(b.params, " ");
                            if (!Be.test(O))
                                throw new Error(`\`@custom-variant ${O}\` defines an invalid variant name. Variants should only contain alphanumeric, dashes or underscore characters.`);
                            ...
                            if (b.nodes.length === 0) {
                                ...
                                if (K.length === 0 || K.some(h => h.trim() === ""))
                                    throw new Error(`\`@custom-variant ${O} (${K.join(",")})\` selector is invalid.`);
                                let i = []
                                    , f = [];
                                for (let h of K)
                                    h = h.trim(),
                                        h[0] === "@" ? i.push(h) : f.push(h);
                                p.push(h => {
                            ...
                            for (let K of O)
                                if (K.startsWith("source(")) {
                                    ...
                                    U(b.nodes, (f, {replaceWith: h}) => {
                                            if (f.kind === "at-rule" && f.name === "@tailwind" && f.params === "utilities")
                                                return f.params += ` source(${i})`,
                                                    h([Q({
                                                        sourceBase: V.base
                                                    }, [f])]),
                                                    2
                                    ...
                                    U(b.nodes, f => {
                                            if (f.kind === "at-rule" && f.name === "@theme")
                                                return f.params += ` prefix(${i})`,
                                                    1
                                        }
                                    )
                                } else
                                    K === "important" ? s = !0 : K === "reference" ? b.nodes = [Q({
                                        reference: !0
                                    }, b.nodes)] : R.push(K);
                        ...
                        if (b.name === "@theme") {
                            ...
                            if (V.reference && (O |= 2),
                                R) {
                                if (!Pn.test(R))
                                    throw new Error(`The prefix "${R}" is invalid. Prefixes must be lowercase ASCII letters (a-z) only.`);
                                l.prefix = R
                            }
                            return U(b.nodes, K => {
                                    if (K.kind === "at-rule" && K.name === "@keyframes")
                                        return l.addKeyframes(K),
                                            1;
                                    if (K.kind === "comment")
                                        return;
                                    ...
                                    let i = Y([_(b.name, b.params, [K])]).split(`
...
${i}`)
        ...
        async function jn(t, r={}) {
            let {designSystem: o, ast: e, globs: n, root: s, utilitiesNode: l, features: p} = await zn(t, r);
            e.unshift(De(`! tailwindcss v${Nt} | MIT License | https://tailwindcss.com `));
            function c(m) {
            ...
            return {
                ...
                build(m) {
                    ...
                    let v = !1
                        , y = d.size;
                    for (let x of m)
                        o.invalidCandidates.has(x) || (x[0] === "-" && x[1] === "-" ? o.theme.markUsedVariable(x) : d.add(x),
                            v ||= d.size !== y);
                    if (!v)
                        return u ??= se(e, o),
                            u;
...
`;
        ...
        ;
        var eo = "text/tailwindcss", Xe, St = new Set, Ct = "", $t = document.createElement("style"), Xr = Promise.resolve(), qn = 1, B = new Qe;
        async function Hn() {
        ...
        new MutationObserver(t => {
                ...
                for (let e of t) {
                    for (let n of e.addedNodes)
                        n.nodeType === Node.ELEMENT_NODE && n.tagName === "STYLE" && n.getAttribute("type") === eo && (to(n),
                            r++);
                    for (let n of e.addedNodes)
                        n.nodeType === 1 && n !== $t && o++;
                    e.type === "attributes" && o++
